...
/**
 * This class provides basic functionality of PNPageBase
 */
abstract class PNPageBase extends PNMUTransport
{
    /**
     ...
     */
    function PNPageBase($init = null, $key = 0, $field = null)
    {
    ...
    public function __toString() {
        $string  = 'Instance of the class "PNPageBase' . "\n";
