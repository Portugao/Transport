 ...
 * Define Class path
 */
define('MUTRANSPORT_FILTERUTIL_CLASS_PATH', 'modules/MUTransport/classes/FilterUtil');

Loader::loadClass('FilterUtil_Plugin', MUTRANSPORT_FILTERUTIL_CLASS_PATH);
...
class FilterUtil extends FilterUtil_Common
{
     ...
     * @return object FilterUtil object
     */
    public function __construct($args = array())
    {
        $this->setVarName('filter');
        parent::__construct($args);
        $this->plugin = new FilterUtil_Plugin($this->addCommon(), array('Default' => array()));
