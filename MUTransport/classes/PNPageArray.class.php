...
Loader::loadClass('PNPageArrayBase', 'modules/MUTransport/classes');

/**
 * This class implements the functionality of PNPageArrayBase
 */
class PNPageArray extends PNPageArrayBase
{
