...
/**
 * This class provides basic functionality of PNModulArrayBase
 */
abstract class PNModulArrayBase extends PNMUTransportArray
{
    /**
     ...
     */
    function PNModulArrayBase($init = null, $where = '', $orderBy = '', $assocKey = null)
    {
    ...
    public function __toString() {
        $string  = 'Instance of the class "PNModulArrayBase' . "\n";
