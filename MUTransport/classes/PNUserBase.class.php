 ...
 * @package PostNuke_Generated_Useres
...
/**
 * This class provides basic functionality of PNUserBase
 */
abstract class PNUserBase extends PNMUTransport
{
    /**
     ...
     */
    function PNUserBase($init = null, $key = 0, $field = null)
    {
    ...
    public function __toString() {
        $string  = 'Instance of the class "PNUserBase' . "\n";
