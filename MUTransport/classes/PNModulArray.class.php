...
Loader::loadClass('PNModulArrayBase', 'modules/MUTransport/classes');

/**
 * This class implements the functionality of PNModulArrayBase
 */
class PNModulArray extends PNModulArrayBase
{
