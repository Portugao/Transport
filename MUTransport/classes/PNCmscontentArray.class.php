...
Loader::loadClass('PNCmscontentArrayBase', 'modules/MUTransport/classes');

/**
 * This class implements the functionality of PNCmscontentArrayBase
 */
class PNCmscontentArray extends PNCmscontentArrayBase
{
