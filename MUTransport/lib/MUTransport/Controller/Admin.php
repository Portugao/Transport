...
// DEBUG: permission check aspect ends
    ...
    $this->view->clear_cache('MUTransport_admin_'.$objectType. '_view.htm');                          

    // fetch and return the appropriate template
    return $this->view->fetch('MUTransport_admin_'.$objectType. '_view.htm');
}
/**
...
//    $dom = ZLanguage::getModuleDomain('MuTransport');
    ...
    // fetch and return the appropriate template
    return $this->view->fetch('MUTransport_admin_' . $objectType . '_display.htm');
}
...
// DEBUG: permission check aspect ends
    ...
    return $this->view->pnFormExecute('MUTransport_admin_' . $objectType . '_edit.htm', new $handlerClass());
}
