...
namespace MU\TransportModule\Entity\Repository\Base;
 ...
 *
 * This is the base repository class for field entities.
 */
abstract class AbstractFieldRepository extends EntityRepository
{
    /**
     * @var string The main entity class
     */
    protected $mainEntityClass = 'MU\TransportModule\Entity\FieldEntity';

    /**
     * @var string The default sorting field/expression
     */
    protected $defaultSortingField = 'fieldName';
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApiInterface $currentUserApi)
    {
        ...
        $logArgs = ['app' => 'MUTransportModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'fields', 'userid' => $userId];
     ...
     *
     * @return array|fieldEntity Retrieved data array or fieldEntity instance
     */
     ...
     * @param boolean $slimMode If activated only some basic fields are selected without using any joins (optional) (default=false)
     *
     * @return ArrayCollection Collection containing retrieved fieldEntity instances
     */
    public function selectByIdList($idList = [0], $useJoins = true, $slimMode = false)
    {
        ...
        if (!$slimMode && null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('field', $qb);
        }
    ...
    public function getListQueryBuilder($where = '', $orderBy = '', $useJoins = true, $slimMode = false)
    {
        ...
        if (!$slimMode && null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addCommonViewFilters('field', $qb);
        }
    ...
    public function selectSearch($fragment = '', array $exclude = [], $orderBy = '', $currentPage = 1, $resultsPerPage = 25, $useJoins = true)
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addSearchFilter('field', $qb, $fragment);
        }
    ...
    {
        $selection = 'COUNT(tbl.id) AS numFields';
    ...
    public function selectCount($where = '', $useJoins = false, array $parameters = [])
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('field', $qb, $parameters);
        }
     ...
     * @param integer $excludeId  Id of fields to exclude (optional)
     *
     * @return boolean Result of this check, true if the given field does not already exist
     */
    ...
    {
        $qb->leftJoin('tbl.table', 'tblTable');
