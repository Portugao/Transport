...
abstract class AbstractListEntriesHelper
{
    ...
    public function getEntries($objectType, $fieldName)
    {
        ...
        switch ($objectType) {
            case 'table':
                switch ($fieldName) {
                    case 'workflowState':
                        $entries = $this->getWorkflowStateEntriesForTable();
                        break;
                }
                break;
            case 'database':
                switch ($fieldName) {
                    case 'workflowState':
                        $entries = $this->getWorkflowStateEntriesForDatabase();
                        break;
                }
                break;
            case 'field':
                switch ($fieldName) {
                    case 'workflowState':
                        $entries = $this->getWorkflowStateEntriesForField();
                        break;
                }
                break;
        }
     ...
     * @return array Array with desired list entries
     */
    public function getWorkflowStateEntriesForTable()
    {
        $states = [];
        $states[] = [
            'value'   => 'approved',
     ...
     * @return array Array with desired list entries
     */
    public function getWorkflowStateEntriesForDatabase()
    {
        $states = [];
        $states[] = [
            'value'   => 'approved',
     ...
     * @return array Array with desired list entries
     */
    public function getWorkflowStateEntriesForField()
    {
        $states = [];
        $states[] = [
            'value'   => 'approved',
