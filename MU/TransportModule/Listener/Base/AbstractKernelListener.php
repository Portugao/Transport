...
abstract class AbstractKernelListener implements EventSubscriberInterface
{
     ...
     *     `$testMessage = 'Hello from transport app';
     *     $event->getRequest()->attributes->set('MUTransportModule_test', $testMessage);`
     *
     ...
     *     `$testMessage = $event->getRequest()->attributes->get('MUTransportModule_test');`
     *     now `$testMessage` should be: `'Hello from transport app'`
     *
     ...
     *         $response = new Response();
     *         $message = sprintf('transport App Error says: %s with code: %s', $exception->getMessage(), $exception->getCode());
