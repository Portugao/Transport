...
abstract class AbstractFieldController extends AbstractController
{
    ...
    protected function viewInternal(Request $request, $sort, $sortdir, $pos, $num, $isAdmin = false)
    {
        ...
        foreach ($templateParameters['items'] as $field) {
            if (!$this->hasPermission('MUTransportModule:' . ucfirst($objectType) . ':', $field->getKey() . '::', $permLevel)) {
                continue;
            }
    ...
    {
        return $this->deleteInternal($request, $field, true);
    }
    ...
    {
        return $this->deleteInternal($request, $field, false);
    }
    
    /**
     * This method includes the common implementation code for adminDelete() and delete().
     */
    protected function deleteInternal(Request $request, FieldEntity $field, $isAdmin = false)
    {
        // parameter specifying which type of objects we are treating
        $objectType = 'field';
        ...
        $form = $this->createForm('Zikula\Bundle\FormExtensionBundle\Form\Type\DeletionType', $field);
    ...
    protected function handleSelectedEntriesActionInternal(Request $request, $isAdmin = false)
    {
        ...
        foreach ($items as $itemId) {
            ...
            if ($action != 'delete') {
                ...
                $url = new RouteUrl('mutransportmodule_field_display', $urlArgs);
            }
