...
abstract class AbstractDatabaseController extends AbstractController
{
    ...
    protected function viewInternal(Request $request, $sort, $sortdir, $pos, $num, $isAdmin = false)
    {
        ...
        foreach ($templateParameters['items'] as $database) {
            if (!$this->hasPermission('MUTransportModule:' . ucfirst($objectType) . ':', $database->getKey() . '::', $permLevel)) {
                continue;
            }
    ...
    {
        return $this->deleteInternal($request, $database, true);
    }
    ...
    {
        return $this->deleteInternal($request, $database, false);
    }
    
    /**
     * This method includes the common implementation code for adminDelete() and delete().
     */
    protected function deleteInternal(Request $request, DatabaseEntity $database, $isAdmin = false)
    {
        // parameter specifying which type of objects we are treating
        $objectType = 'database';
        ...
        $form = $this->createForm('Zikula\Bundle\FormExtensionBundle\Form\Type\DeletionType', $database);
