...
abstract class AbstractTableController extends AbstractController
{
    ...
    {
        return $this->deleteInternal($request, $table, true);
    }
    ...
    {
        return $this->deleteInternal($request, $table, false);
    }
    
    /**
     * This method includes the common implementation code for adminDelete() and delete().
     */
    protected function deleteInternal(Request $request, TableEntity $table, $isAdmin = false)
    {
        // parameter specifying which type of objects we are treating
        $objectType = 'table';
        ...
        $form = $this->createForm('Zikula\Bundle\FormExtensionBundle\Form\Type\DeletionType', $table);
