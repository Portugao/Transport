...
use MU\TransportModule\Form\Type\ConfigType;
...
abstract class AbstractConfigController extends AbstractController
{
    ...
    {
        if (!$this->get('mu_transport_module.permission_helper')->hasPermission(ACCESS_ADMIN)) {
            throw new AccessDeniedException();
        }
        
        $form = $this->createForm(ConfigType::class, $this->get('mu_transport_module.app_settings'));
        ...
        if ($form->handleRequest($request)->isValid()) {
            ...
            return $this->redirectToRoute('mutransportmodule_config_config');
        }
        ...
        return $this->render('@MUTransportModule/Config/config.html.twig', $templateParameters);
    }
}
