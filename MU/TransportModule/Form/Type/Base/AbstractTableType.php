...
/**
 * Table editing form type base class.
 */
abstract class AbstractTableType extends AbstractType
{
    use TranslatorTrait;
    ...
    public function addEntityFields(FormBuilderInterface $builder, array $options = [])
    {
        ...
        $builder->add('name', TextType::class, [
            ...
            'attr' => [
                'maxlength' => 255,
                'class' => '',
                'title' => $this->__('Enter the name of the table.')
            ],
            'required' => true,
        ]);
        ...
        $builder->add('description', TextareaType::class, [
            ...
            'attr' => [
                'maxlength' => 2000,
                'class' => '',
                'title' => $this->__('Enter the description of the table.')
            ],
            'required' => false,
        ]);
    }
    ...
    public function addIncomingRelationshipFields(FormBuilderInterface $builder, array $options = [])
    {
        ...
        $builder->add('database', 'Symfony\Bridge\Doctrine\Form\Type\EntityType', [
            'class' => 'MUTransportModule:DatabaseEntity',
            ...
            'attr' => [
                'title' => $this->__('Choose the database.')
            ]
        ]);
    }
    ...
    {
        return 'mutransportmodule_table';
    }
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver
            ->setDefaults([
                ...
                'data_class' => 'MU\TransportModule\Entity\TableEntity',
                'empty_data' => function (FormInterface $form) {
                    return $this->entityFactory->createTable();
                },
                'error_mapping' => [
                ],
                'mode' => 'create',
