...
/**
 * Field quick navigation form type base class.
 */
abstract class AbstractFieldQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    * @param EntityDisplayHelper $entityDisplayHelper EntityDisplayHelper service instance
    ...
    public function addIncomingRelationshipFields(FormBuilderInterface $builder, array $options = [])
    {
        ...
        $builder->add('table', EntityType::class, [
    ...
    {
        $listEntries = $this->listHelper->getEntries('field', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        return 'mutransportmodule_fieldquicknav';
    }
}
