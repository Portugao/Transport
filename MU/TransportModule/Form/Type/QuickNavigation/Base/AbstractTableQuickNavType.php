...
/**
 * Table quick navigation form type base class.
 */
abstract class AbstractTableQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    * @param EntityDisplayHelper $entityDisplayHelper EntityDisplayHelper service instance
    ...
    public function addIncomingRelationshipFields(FormBuilderInterface $builder, array $options = [])
    {
        ...
        $builder->add('database', EntityType::class, [
    ...
    {
        $listEntries = $this->listHelper->getEntries('table', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        return 'mutransportmodule_tablequicknav';
    }
}
