...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    public function processForm(array $templateParameters = [])
    {
        ...
        if ($this->templateParameters['mode'] == 'create') {
            if (!$this->modelHelper->canBeCreated($this->objectType)) {
                $this->request->getSession()->getFlashBag()->add('error', $this->__('Sorry, but you can not create the table yet as other items are required which must be created before!'));
    ...
    protected function initRelationPresets()
    {
        ...
        $this->relationPresets['database'] = $this->request->get('database', '');
    ...
    protected function getRedirectUrl(array $args = [])
    {
        ...
        if ($this->request->getSession()->has('mutransportmodule' . $this->objectTypeCapital . 'Referer')) {
            $this->request->getSession()->remove('mutransportmodule' . $this->objectTypeCapital . 'Referer');
        }
