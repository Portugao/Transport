...
use MU\TransportModule\Listener\EntityLifecycleListener;
...
{
    /**
     * The mutransportmodule.itemactionsmenu_pre_configure event is thrown before the item actions
     * menu is built in the menu builder.
     *
     * The event listener receives an
     * MU\TransportModule\Event\ConfigureItemActionsMenuEvent instance.
     *
     * @see MU\TransportModule\Menu\MenuBuilder::createItemActionsMenu()
     * @var string
     */
    const MENU_ITEMACTIONS_PRE_CONFIGURE = 'mutransportmodule.itemactionsmenu_pre_configure';
    
    /**
     * The mutransportmodule.itemactionsmenu_post_configure event is thrown after the item actions
     ...
     * @var string
     */
    const MENU_ITEMACTIONS_POST_CONFIGURE = 'mutransportmodule.itemactionsmenu_post_configure';
    /**
